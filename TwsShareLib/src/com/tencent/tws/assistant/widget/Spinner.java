...
public class Spinner extends AbsSpinner implements OnClickListener {
    ...
    private int mSpinneMode=MODE_DROPDOWN;
    ...
    public Spinner(Context context, AttributeSet attrs, int defStyle, int mode) {
	 ...
	 mSpinneMode=mode;
        ...
        if (mSpinneMode == MODE_THEME) {
        	Log.i(TAG, "Spinner a= " + a.toString() + "; mSpinneMode = " + mSpinneMode);
            mSpinneMode = a.getInt(R.styleable.Spinner_spinnerMode, MODE_DIALOG);
        }
        ...
        case MODE_DROPDOWN: {
			...
			popup.setBackgroundDrawable(getResources().getDrawable(R.drawable.tws_listview_dropdown_background));
			popup.setListSelector(getResources().getDrawable(R.drawable.transparent_background));
            final int verticalOffset = 0;/*a.getDimensionPixelOffset(
                    android.R.styleable.Spinner_dropDownVerticalOffset, 0);*/
            if (verticalOffset != 0) {
                popup.setVerticalOffset(verticalOffset);
            }

            final int horizontalOffset = 0;/*a.getDimensionPixelOffset(
                    android.R.styleable.Spinner_dropDownHorizontalOffset, 0);*/
        ...
        //        android.R.styleable.Spinner_disableChildrenWhenDisabled, false);
    ...
    public void setAdapter(SpinnerAdapter adapter) {
        ...
        if (mPopup != null) {
            mPopup.setAdapter(new DropDownAdapter(adapter,mSpinneMode,getContext().getResources().getDimension(R.dimen.tws_listview_item_small_height)));
        } else {
            mTempAdapter = new DropDownAdapter(adapter,mSpinneMode,getContext().getResources().getDimension(R.dimen.tws_listview_item_small_height));
        }
    }
    ...
    private static class DropDownAdapter implements ListAdapter, SpinnerAdapter {
	 ...
	 public DropDownAdapter(SpinnerAdapter adapter,int spinnerMode,float itemHeight) {
        this.mAdapter = adapter;
		mItemHeight=(int)itemHeight;
		this.mSpinneMode=spinnerMode;
        if (adapter instanceof ListAdapter) {
                this.mListAdapter = (ListAdapter) adapter;
            }
        }
        ...
        public View getDropDownView(int position, View convertView, ViewGroup parent) {
            View itemView=null;
            itemView =( mAdapter == null ? null :
                    mAdapter.getDropDownView(position, convertView, parent));
            //Log.d("spinner","getDropDownView----------------getCount()"+getCount()+";mSpinneMode = "+mSpinneMode);
           	if(/*mSpinneMode==MODE_DROPDOWN && */itemView!=null && getCount() > 0)
           	{
           		//itemView.setHeight(mItemHeight);
            	if(position==0)
            	{
            	    itemView.setBackgroundResource(R.drawable.tws_preference_top_item);
	        	}
	        	else if(position==getCount()-1)
	        	{
	        	    itemView.setBackgroundResource(R.drawable.tws_preference_last_item);
	        	}
	        	else
	        	{
	        	    itemView.setBackgroundResource(R.drawable.tws_preference_item);
	        	}
           	}
            return itemView;
        }
    ...
    private class DialogPopup implements SpinnerPopup, DialogInterface.OnClickListener {
        ...
        public void show() {
            AlertDialog.Builder builder = new AlertDialog.Builder(getContext(),R.style.Theme_tws_Second_Dialog_default);
            if (mPrompt != null) {
           ...
           if(mListView != null){
	  			...
	  			//mPopup.getListView().setDivider(getContext().getResources().getDrawable(R.drawable.spinner_dialog_divider));
	  			if(mHeight != -1){
    ...
    private class DropdownPopup extends ListPopupWindow implements SpinnerPopup {
        ...
        public DropdownPopup(Context context, AttributeSet attrs, int defStyleRes) {
            super(context, null, 0, R.style.Theme_tws);
