...
public abstract class PreferenceFragment extends Fragment implements
    ...
    public void bindPreferences() {
        ...
        if (preferenceScreen != null) {
			...
			int mPadding = (int)getActivity().getResources().getDimension(R.dimen.tws_listview_item_padding_side_left);
			...
			if(mPreference instanceof PreferenceCategory){
				...
				int mPaddingTop = (int)getActivity().getResources().getDimension(R.dimen.preference_item_padding_side_top_no_preferencecategory);
				mListView.setPadding(mMargin,0,mMargin,0);
			}
