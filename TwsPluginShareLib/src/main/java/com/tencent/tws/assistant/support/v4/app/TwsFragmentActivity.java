 ...
 * </ul>
 */
public class TwsFragmentActivity extends TwsActivity {
    private static final String TAG = "TwsFragmentActivity";
    ...
    final FragmentContainer mContainer = new FragmentContainer() {
        ...
        public View findViewById(int id) {
            return TwsFragmentActivity.this.findViewById(id);
        }
    };
    ...
    public void dump(String prefix, FileDescriptor fd, PrintWriter writer, String[] args) {
        ...
        writer.print(prefix); writer.print("Local TwsFragmentActivity ");
