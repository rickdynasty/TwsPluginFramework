...
public abstract class DialogPreference extends Preference implements
	...
	private boolean bShowBottom = false;
    ...
    public DialogPreference(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
                android.R.styleable.DialogPreference, defStyle, 0);
        ...
        mDialogMessage = a.getString(android.R.styleable.DialogPreference_dialogMessage);
        mDialogIcon = a.getDrawable(android.R.styleable.DialogPreference_dialogIcon);
        mPositiveButtonText = a.getString(android.R.styleable.DialogPreference_positiveButtonText);
        mNegativeButtonText = a.getString(android.R.styleable.DialogPreference_negativeButtonText);
        mDialogLayoutResId = a.getResourceId(android.R.styleable.DialogPreference_dialogLayout,
                mDialogLayoutResId);
        a.recycle();
    ...
    protected void showDialog(Bundle state) {
		...
		if(bShowBottom){
	        mBuilder = new AlertDialog.Builder(context, bShowBottom)
	            //.setTitle(mDialogTitle)
	            .setIcon(mDialogIcon)
	            .setPositiveButton(mPositiveButtonText, this)
	            .setNegativeButton(mNegativeButtonText, this);
		}else{
			mBuilder = new AlertDialog.Builder(context, bShowBottom, R.style.Theme_tws_Second_Dialog_Alert)
	            .setTitle(mDialogTitle)
	            .setIcon(mDialogIcon)
	            .setPositiveButton(mPositiveButtonText, this)
	            .setNegativeButton(mNegativeButtonText, this);
        ...
        // Create the dialog
        final TwsDialog dialog = mDialog = mBuilder.create(bShowBottom);
        if (state != null) {
     ...
     */
    private void requestInputMethod(TwsDialog dialog) {
	...
	//add
	public void setShowFromBottom(boolean b){
		bShowBottom = b;
	}
