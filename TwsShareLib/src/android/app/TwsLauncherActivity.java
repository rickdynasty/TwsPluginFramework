 ...
 *
 */
public abstract class TwsLauncherActivity extends TwsListActivity {
    Intent mIntent;
    ...
    private class ActivityAdapter extends BaseAdapter implements Filterable {
        ...
        public ActivityAdapter(IconResizer resizer) {
            ...
            mInflater = (LayoutInflater) TwsLauncherActivity.this.getSystemService(
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                view = mInflater.inflate(
                        R.layout.activity_list_item_2, parent, false);
            } else {
                view = convertView;
            }
    ...
    public class IconResizer {
        ...
        public IconResizer() {
            ...
            final Resources resources = TwsLauncherActivity.this.getResources();
