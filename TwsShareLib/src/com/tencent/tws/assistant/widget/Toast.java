...
public class Toast {
    ...
    public Toast(Context context,int onTop) {
        mContext = context;
        mTN = new TN(onTop);
    ...
    public static Toast makeText(Context context, CharSequence text, int duration,int onTop) {
        Toast result = new Toast(context,onTop);
