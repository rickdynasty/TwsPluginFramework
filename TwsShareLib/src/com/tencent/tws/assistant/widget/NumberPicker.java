...
public class NumberPicker extends LinearLayout {
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        final int layoutResId = attributesArray.getResourceId(
                R.styleable.NumberPicker_layout, DEFAULT_LAYOUT_RESOURCE_ID);
        ...
        mNormalTextSize = attributesArray.getDimensionPixelSize(R.styleable.NumberPicker_normalTextSize, defNormalTextSize);
        mNormalTextColor = attributesArray.getColor(R.styleable.NumberPicker_normalTextColor, getResources().getColor(R.color.tws_white));
...
//                    mNormalTextColor);
            if (clip <= elementHeight) {
                currentTextSize = mNormalTextSize
                        * (1 + Math.abs(textScale - ((clip * textScale) / elementHeight)));
            } else {
                currentTextSize = mNormalTextSize;
            }
        ...
        public CharSequence filter(CharSequence source, int start, int end, Spanned dest, int dstart, int dend) {
            if (mDisplayedValues == null) {
                ...
                /*
                        ...
                        * want to delete some numbers and then type a new number.
                        */
                /*NANJISTART::modify::geofffeng::20120522 add for too many zeros*/
