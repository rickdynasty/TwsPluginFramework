...
import com.tencent.tws.assistant.support.v4.content.Loader;
import com.tencent.tws.assistant.support.v4.util.DebugUtils;
import com.tencent.tws.assistant.support.v4.util.SparseArrayCompat;
...
class LoaderManagerImpl extends LoaderManager {
    ...
    LoaderManagerImpl(String who, TwsFragmentActivity activity, boolean started) {
        mWho = who;
        mActivity = activity;
        mStarted = started;
    }
    
    void updateActivity(TwsFragmentActivity activity) {
        mActivity = activity;
    }
