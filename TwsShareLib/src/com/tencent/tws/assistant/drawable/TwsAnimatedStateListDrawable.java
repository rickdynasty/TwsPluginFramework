...
public class TwsAnimatedStateListDrawable extends TwsStateListDrawable {
    private static final String LOGTAG = TwsAnimatedStateListDrawable.class.getSimpleName();
...
//            Log.d(LOGTAG, "jumpToCurrentState:selectDrawable=" + mTransitionToIndex);
    ...
    public void inflate(@NonNull Resources r, @NonNull XmlPullParser parser,
        ...
        inflateChildElements(r, parser, attrs, null);
...
//        state.mAnimThemeAttrs = a.extractThemeAttrs();
        ...
        state.setVariablePadding(a.getBoolean(
                R.styleable.AnimatedStateListDrawable_android_variablePadding, state.mVariablePadding));
        state.setConstantSize(a.getBoolean(
                R.styleable.AnimatedStateListDrawable_android_constantSize, state.mConstantSize));
        state.setEnterFadeDuration(a.getInt(
                R.styleable.AnimatedStateListDrawable_android_enterFadeDuration, state.mEnterFadeDuration));
        state.setExitFadeDuration(a.getInt(
                R.styleable.AnimatedStateListDrawable_android_exitFadeDuration, state.mExitFadeDuration));

        setDither(a.getBoolean(
                R.styleable.AnimatedStateListDrawable_android_dither, state.mDither));
//        setAutoMirrored(a.getBoolean(
//                R.styleable.AnimatedStateListDrawable_android_autoMirrored, state.mAutoMirrored));
    }
    ...
    private int parseTransition(@NonNull Resources r, @NonNull XmlPullParser parser,
        ...
        final TypedArray a = r.obtainAttributes(attrs,R.styleable.AnimatedStateListDrawableTransition);
    ...
    private int parseItem(@NonNull Resources r, @NonNull XmlPullParser parser,
        ...
        final int keyframeId = a.getResourceId(R.styleable.AnimatedStateListDrawableItem_android_id, 0);
        Drawable dr = a.getDrawable(R.styleable.AnimatedStateListDrawableItem_android_drawable);
        a.recycle();
    ...
    static class AnimatedStateListState extends StateListState {
        ...
        AnimatedStateListState(@Nullable AnimatedStateListState orig,
                @NonNull TwsAnimatedStateListDrawable owner, @Nullable Resources res) {
        ...
        public Drawable newDrawable(Resources res) {
            return new TwsAnimatedStateListDrawable(this, res);
        }
    ...
    private TwsAnimatedStateListDrawable(@Nullable AnimatedStateListState state, @Nullable Resources res) {
        super(null);
