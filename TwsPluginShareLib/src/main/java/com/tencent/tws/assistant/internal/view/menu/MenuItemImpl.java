...
public final class MenuItemImpl implements MenuItem {
	...
	public CharSequence twsGetTitleForItemView(MenuView.ItemView itemView) {
		return getTitleForItemView(itemView);
	}

	public boolean twsShouldShowShortcut() {
		return shouldShowShortcut();
	}

	public String twsGetShortcutLabel() {
		return getShortcutLabel();
	}

	public char twsGetShortcut() {
		return getShortcut();
	}
