 ...
 */
@RemoteView
public class TwsLinearLayout extends ViewGroup {
    ...
    public TwsLinearLayout(Context context) {
        super(context);
    }

    public TwsLinearLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }
    
    public TwsLinearLayout(Context context, AttributeSet attrs, int defStyle) {
