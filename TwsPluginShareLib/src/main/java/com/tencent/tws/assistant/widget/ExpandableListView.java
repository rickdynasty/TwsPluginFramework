...
public class ExpandableListView extends ListView {
	...
	// tws-start fix divider in expandablelistview::2014-08-07
     // tws-start modify 0.2 expandablelistview style::2014-10-04
//	setDivider(new ColorDrawable(context.getResources().getColor(R.color.tws_light_black)));
//	setDividerHeight(1);
//	setChildDivider(null);
	setGroupIndicator(null);
	// tws-end modify 0.2 expandablelistview style::2014-10-04
	// tws-end fix divider in expandablelistview::2014-08-07
    }
    ...
    void drawDivider(Canvas canvas, Rect bounds, int childIndex) {
        ...
        if (flatListPosition >= 0) {
            ...
            if ((pos.position.type == ExpandableListPosition.CHILD) /*|| (pos.isExpanded() &&
                ...
                // tws-start fix divider in expandablelistview::2014-08-07
                if (divider != null) {
                	divider.setBounds(new Rect(0, 0, 0, 0));
	               	divider.draw(canvas);
                	pos.recycle();
                }
		// tws-end fix divider in expandablelistview::2014-08-07
