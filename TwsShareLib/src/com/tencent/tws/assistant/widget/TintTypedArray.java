...
/**
 * A class that wraps a {@link android.content.res.TypedArray} and provides the same public API surface. The
 * purpose of this class is so that we can intercept the {@link #getDrawable(int)} call and tint the result.
 * 
 * @hide
 */
