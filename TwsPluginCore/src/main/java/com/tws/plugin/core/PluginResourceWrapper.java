...
public class PluginResourceWrapper extends Resources {
	...
	public String getResourcePackageName(int resid) throws NotFoundException {
		...
		try {
			...
			QRomLog.e(TAG, "NotFoundException Try Following resid=" + Integer.toHexString(resid));
			...
			QRomLog.e(TAG, "NotFoundException Try Following resid=" + Integer.toHexString(resid), e);
