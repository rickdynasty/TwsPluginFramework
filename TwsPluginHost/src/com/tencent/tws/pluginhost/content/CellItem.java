package com.tencent.tws.pluginhost.content;
...
public class CellItem extends LinearLayout {
	...
	private void init(Context context) {
		...
		// weight 在设置LayoutParams的时候处理 craete ImageView
		...
		ivParams.topMargin = (int) getResources().getDimension(R.dimen.home_bottom_tab_img_margin_top);
		mImageView.setLayoutParams(ivParams);
		// mImageView.setBackgroundResource(R.drawable.home_bottom_tab_my_watch_default);
		addView(mImageView, 0);

		// create TextView
		mTextView = new TextView(context);
		LayoutParams tvParams = new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
		tvParams.topMargin = (int) getResources().getDimension(R.dimen.home_bottom_tab_text_margin_top);
