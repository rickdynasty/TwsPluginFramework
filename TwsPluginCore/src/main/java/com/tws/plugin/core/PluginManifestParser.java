					...
					if ("manifest".equals(tag)) {
						...
						for (int index = 0; index < displays.length; index++) {
							...
							for (int i = 0; i < configs.length; i++) {
								...
								if (values.length != 2) {
									QRomLog.e(TAG, "ERROR plugin-display configs:" + configs[i]);
									continue;
								}
								...
								if ("pos".equals(values[0])) {
									...
									if (1 < locations.length) {
										...
										QRomLog.w(TAG, "Plugin:" + packageName
								...
								} else if ("ab-titlerestype".equals(values[0])) {
									displayConfig.ab_titlerestype = Integer.parseInt(values[1]);
								...
								} else if ("ab-lbtnrestype".equals(values[0])) {
									displayConfig.ab_lbtnrestype = Integer.parseInt(values[1]);
								} else if ("ab-lbtnres".equals(values[0])) {
									displayConfig.ab_lbtnres = values[1].trim();
								} else if ("ab-lbtncontent".equals(values[0])) {
									displayConfig.ab_lbtncontent = values[1].trim();
								} else if ("ab-lbtnctype".equals(values[0])) {
									displayConfig.ab_lbtnctype = Integer.parseInt(values[1]);
								...
								} else if ("gid".equals(values[0])) {
									displayConfig.gid = values[1].trim();
								} else if ("gpos".equals(values[0])) {
									displayConfig.gpos = Integer.parseInt(values[1]);
								} else if ("gtitle".equals(values[0])) {
									displayConfig.gtitle = values[1].trim();
								} else if ("gicon".equals(values[0])) {
									displayConfig.gicon = values[1].trim();
								}
							}
