...
public class PluginIntentFilter implements Serializable {
	protected static final String TAG = "rick_Print:PluginIntentFilter";
    ...
    /**
     * The filter didn't match any results.
     */
    public static final int NO_MATCH_RESULT = -5;
    ...
    public static class MalformedMimeTypeException extends AndroidException {
    	protected static final String TAG = "rick_Print:MalformedMimeTypeException";
    ...
    public final String matchCategories(Set<String> categories) {
        if (categories == null || mCategories == null) {
            return null;
        }
