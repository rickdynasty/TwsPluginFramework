...
public class MultiSelectListPreference extends DialogPreference {
    ...
    public MultiSelectListPreference(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
                android.R.styleable.MultiSelectListPreference, 0, 0);
        mEntries = a.getTextArray(android.R.styleable.MultiSelectListPreference_entries);
        mEntryValues = a.getTextArray(android.R.styleable.MultiSelectListPreference_entryValues);
        a.recycle();
    }
