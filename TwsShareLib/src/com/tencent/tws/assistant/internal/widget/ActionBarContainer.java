...
/**
 * This class acts as a container for the action bar view and action mode context views. It applies special
 * styles as needed to help handle animated transitions between them.
 * 
 * @hide
 */
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attrs) {
        ...
        mBackgroundResId = a.getResourceId(R.styleable.ActionBar_background, 0);
...
//        final boolean hasTabs = mTabContainer != null && mTabContainer.getVisibility() != GONE;
        ...
        if (mTabContainer != null && mTabContainer.getVisibility() != GONE) {
            ...
            final int shadowHeight = getResources().getDimensionPixelSize(
                    R.dimen.tws_action_bar_shadow_height);
