...
public class TwsScroller  {
    ...
    private static final float INFLEXION = 0.5f; // Tension lines cross at (INFLEXION, 1)
     ...
     */
    public TwsScroller(Context context) {
        this(context, null);
    }
     ...
     */
    public TwsScroller(Context context, Interpolator interpolator) {
     ...
     */
    public TwsScroller(Context context, Interpolator interpolator, boolean flywheel) {
        mFinished = true;
