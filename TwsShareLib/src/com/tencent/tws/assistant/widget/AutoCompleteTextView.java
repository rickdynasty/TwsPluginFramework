...
//        mPopup.setListSelector(a.getDrawable(R.styleable.AutoCompleteTextView_dropDownSelector));
        mPopup.setVerticalOffset(/*(int)
                a.getDimension(R.styleable.AutoCompleteTextView_dropDownVerticalOffset, 0.0f)*/0);
        mPopup.setHorizontalOffset(/*(int)
                a.getDimension(R.styleable.AutoCompleteTextView_dropDownHorizontalOffset, 0.0f)*/0);
        ...
        mPopup.twsSetCustomListHeight(3);
        mPopup.setAnimationStyle(com.tencent.tws.sharelib.R.style.Animation_tws_DropDownLeft);
        mHintResource = a.getResourceId(R.styleable.AutoCompleteTextView_completionHintView,
        		com.tencent.tws.sharelib.R.layout.simple_dropdown_hint);
        
        mPopup.setOnItemClickListener(new DropDownItemClickListener());
//        mPopup.setListSelector(context.getResources().getDrawable(R.drawable.second_list_selector_holo_light));
