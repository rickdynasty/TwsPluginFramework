 ...
 * </p>
 */
public class TwsTabHostV4 extends FrameLayout implements ViewTreeObserver.OnTouchModeChangeListener {
	...
	public TwsTabHostV4(Context context) {
		super(context);
		initTabHost();
	}

	public TwsTabHostV4(Context context, AttributeSet attrs) {
		super(context, attrs);
...
//	}
	...
	public class TabSpec {
		...
		private TwsTabHostV4 mTabHost;

		private TabSpec(String tag, TwsTabHostV4 tabHost) {
			mTag = tag;
			mTabHost = tabHost;
		}
	...
	private class FragmentContentStrategy implements ContentStrategy {
		...
		private FragmentContentStrategy(Fragment fragment, String tag, TwsTabHostV4 tabHost) {
			mFragment = fragment;
			FragmentTransaction transaction = mFragmentManager.beginTransaction();
	...
	void switchToTab(int index) {
		...
		mCurrentTab = index;
		final TwsTabHostV4.TabSpec spec = mTabSpecs.get(index);
