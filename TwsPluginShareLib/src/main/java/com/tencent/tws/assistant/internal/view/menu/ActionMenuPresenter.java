...
public class ActionMenuPresenter extends BaseMenuPresenter implements ActionProvider.SubUiVisibilityListener {
	...
	public ActionMenuPresenter(Context context) {
		/* tws-start::change 2012-10-11 */
		super(context, R.layout.action_menu_layout, R.layout.action_menu_item_layout);
		/* tws-end::change 2012-10-11 */
		// Slog.v(TAG, "ActionMenuPresenter ActionMenuPresenter 0");
		/* tws-start::add::geofffeng::201200508,make sure item width is the same */
	}

	public ActionMenuPresenter(Context context, int actionMod) {
		/* tws-start::change 2012-10-11 */
		super(context, R.layout.action_menu_layout, R.layout.actionmod_menu_item_layout);
		/* tws-end::change 2012-10-11 */
	...
	public void onConfigurationChanged(Configuration newConfig) {
		if (!mMaxItemsSet) {
			/* tws-start::modified com.internal to tws 20121011 */
			mMaxItems = mContext.getResources().getInteger(R.integer.max_action_buttons);
			/* tws-end::modified com.internal to tws 20121011 */
			if (mMenu != null) {
	...
	public void bindItemView(MenuItemImpl item, MenuView.ItemView itemView) {
		...
		if (isActionBarSplitTheme && mWidthLimitSet) {
			...
			int textResId = a.getResourceId(R.styleable.ActionBar_menuitemBottomStyle,
	...
	public void updateMenuView(boolean cleared) {
		...
		final ArrayList<MenuItemImpl> nonActionItems = mMenu != null ? mMenu.twsGetNonActionItems() : null;
	...
	private class OverflowMenuButton extends ImageButton implements ActionMenuChildView {
		public OverflowMenuButton(Context context) {
			...
			setVisibility(VISIBLE);
			setEnabled(true);
			setPadding(0, 0, 0 - (int) context.getResources().getDimension(R.dimen.actionbar_bottom_overflow_padding),
					0);
			setContentDescription("OverflowMenuButton");
			// tws-start add for ripple::2014-12-21
			boolean bRipple = ThemeUtils.isShowRipple(context);
