 ...
 * @hide
 */
class TwsSuggestionsAdapter extends ResourceCursorAdapter implements OnClickListener {
    ...
    public TwsSuggestionsAdapter(Context context, TwsSearchView searchView,
