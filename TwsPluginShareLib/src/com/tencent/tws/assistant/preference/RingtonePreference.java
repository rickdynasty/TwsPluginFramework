...
public class RingtonePreference extends Preference implements
    ...
    public RingtonePreference(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
                android.R.styleable.RingtonePreference, defStyle, 0);
        mRingtoneType = a.getInt(android.R.styleable.RingtonePreference_ringtoneType,
                RingtoneManager.TYPE_RINGTONE);
        mShowDefault = a.getBoolean(android.R.styleable.RingtonePreference_showDefault,
                true);
        mShowSilent = a.getBoolean(android.R.styleable.RingtonePreference_showSilent,
                true);
        a.recycle();
    }
    ...
    protected void onClick() {
        ...
        getPreferenceManager().getActivity().overridePendingTransition(R.anim.push_up_in, 
				R.anim.push_up_out);
    }
