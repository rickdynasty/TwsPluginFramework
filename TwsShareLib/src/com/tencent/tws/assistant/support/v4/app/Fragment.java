...
import com.tencent.tws.assistant.support.v4.util.DebugUtils;
import com.tencent.tws.assistant.support.v4.util.SimpleArrayMap;
...
final class FragmentState implements Parcelable {
    ...
    public Fragment instantiate(TwsFragmentActivity activity, Fragment parent) {
        if (mInstance != null) {
            return mInstance;
        }
...
public class Fragment implements ComponentCallbacks, OnCreateContextMenuListener {
     ...
     */
    final public TwsFragmentActivity getActivity() {
        return mActivity;
    }
    ...
    void performCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            Parcelable p = savedInstanceState.getParcelable(
                    TwsFragmentActivity.FRAGMENTS_TAG);
            if (p != null) {
                if (mChildFragmentManager == null) {
                    instantiateChildFragmentManager();
                }
    ...
    */
    ...
    void performSaveInstanceState(Bundle outState) {
        ...
        if (mChildFragmentManager != null) {
            ...
            if (p != null) {
                outState.putParcelable(TwsFragmentActivity.FRAGMENTS_TAG, p);
            }
        }
    }
